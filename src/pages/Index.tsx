...
import { KeywordPrompts } from '@/components/dashboard/KeywordPrompts';
...
export default function Index() {
  ...
  return (
    <div className="box-border flex w-screen h-screen bg-[#080A0B] m-0 p-0 max-md:flex-col max-md:h-auto">
      <Sidebar
        onNewQuestion={handleNewQuestion}
        onManageInterests={handleManageInterests}
        onMDrive={handleMDrive}
        onPastQuestions={handlePastQuestions}
